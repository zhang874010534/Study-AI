...
![image](https://github.com/zhang874010534/Study-AI/blob/main/images/27636c00-59a8-4121-92d1-4e709e909ca0.png?raw=true)

####  AI专有名词

- **LLM-大型语言模型**

  LLM是基于深度学习技术构建的人工智能模型，由具有数以

  亿计参数的人工神经网络组成，通过自监督学习或半监督学
